 ...
 * model first asks to run `echo <reply>` via the bash/pwsh/powershell tool,
 * then echoes the last (tool-result) message back so the assertion can match
 * `<reply>` in the assistant response.
 */
